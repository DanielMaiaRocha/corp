...
import EditProductModal from "./EditProductModal"; // Importe o modal de edição

const ProductsList = () => {
    const { deleteProduct, toggleFeaturedProduct, products } = useProductStore();
    const [editingProduct, setEditingProduct] = useState(null); // Estado para controlar o produto em edição

    const handleEdit = (product) => {
        setEditingProduct(product); // Abre o modal com o produto selecionado
    };

    const handleUpdate = () => {
        setEditingProduct(null); // Fecha o modal após a atualização
    };
